  ...
  return (
    <Container>
      ...
      <div className='section'>
        ...
        <p className='paragraph'>
          Target priority scores are currently based on the analysis of CRISPR knockout screening data generated by
          the Sanger Institute as published (<a target='_blank' rel='noopener noreferrer'
                                                href='https://pubmed.ncbi.nlm.nih.gov/30971826/'>Behan et al.,
          Nature. 2019</a>). We are in the process of updating the target
          scores based on analysis of the combined Sanger and Broad CRISPR datasets
        </p>
